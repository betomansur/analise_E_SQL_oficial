...
def main(args):
    ...
    for pred in predictions:
        if "timing" in pred:
            sf_list.append(pred["timing"]["SF"])
            csg_list.append(pred["timing"]["CSG"])
            qe_list.append(pred["timing"]["QE"])
            sr_list.append(pred["timing"]["SR"])
            total_list.append(pred["timing"]["total_time"])
