...
class Pipeline():
    ...
    def forward_pipeline_CSG_SR(self, t2s_object: Dict) -> Dict[str, str]:
        ...
        fim_etapa2 = time.time()

        lista_tempo = [fim_etapa1 - inicio, fim_etapa2 - fim_etapa1]

        return t2s_object_prediction, lista_tempo
    ...
    def forward_pipeline_CSG_QE_SR(self, t2s_object: Dict) -> Dict:
        ...
        fim_etapa3 = time.time()

        lista_tempo = [fim_etapa1 - inicio, fim_etapa2 - fim_etapa1, fim_etapa3 - fim_etapa2]
    ...
    def forward_pipeline_SF_CSG_QE_SR(self, t2s_object: Dict) -> Dict:
        ...
        t2s_object_prediction = t2s_object
        fim_etapa4 = time.time()

        lista_tempo = [fim_etapa1 - inicio, fim_etapa2 - fim_etapa1, fim_etapa3 - fim_etapa2, fim_etapa4 - fim_etapa3]
